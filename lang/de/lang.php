...
return [
    ...
    'globalsettings' => [
        ...
        'selectSVGcommand' => 'Geben Sie die class <b>SVG</b> mit an, um alle Styles zu übernehmen  <br>Beispiel: <div style="color: #c3c3c3; border: 1.5px solid #18191a; box-shadow: 0 0 3px -1px rgba(0,0,0,0.79); padding: 8px; background-color: #303136; width: min-content;"><pre style="margin-bottom: 0!important;">&lt;svg class="svg"&gt;&lt;path d="M32,10c12.1"/&gt;&lt;/svg&gt;</pre></div>',
        'svgSection' => 'Bewertungssterne als SVG',
        'selectSVG' => 'Geben Sie Ihre SVG an die für die Bewertungssterne verwendet wird.',
        'SvgColorLabel' => 'Farbe der SVG-Sterne',
        'SVGColorComment' => 'Legen Sie eine Farbe für die SVG-Sterne fest',
        'seoSection' => 'Einstellungen für SEO Links',
        'detaillink_desc' => 'Öffnet Objekt- und Haus-Detailseiten in neuem Fenster',
        'datecompact' => 'An und Abreise zusammen',
        ...
        'map_set_section' => 'Datenschutzoptionen',
        'map_activation' => 'Datenschutzabfrage für Karten',
        'map_activation_desc' => '<b>Hinweis: </b> Die Aktivierung wird aus Datenschutzgründen <b>dringend</b> empfohlen',
        'map_hint_text' => 'Datenschutz Hinweistext',
        'map_hint_btn_text' => 'Button Label Karte anzeigen',
        'map_hint_cookie_text' => 'Checkbox Label Cookie speichern',
        'map_hint_cookie_time' => 'Speicherdauer für Cookie in Tage',
        'map_hint_cookie_time_desc' => 'Legt die Dauer für die Speicherung des Karten-Cookies in Tage fest. <br> Wenn 0 Tage ausgewählt sind, wird der Cookie nach beenden der Browsersitzung gelöscht.',
        'map_allg_section' => 'Karten anpassen',
        ...
        'hobexrequest' => 'Zielseite Zahlung abgeschlossen',
        ...
        'blockieren' => 'Angebote (gelb) blockieren',
        'blockieren_desc' => 'Angebote aus Fewo-Verwalter im Belegungsplan blockieren',
        ...
        'cronBeforeDefault' => 'Anreisemail bei jeder Buchung unabhängig von Werbemailzustimmung',
    ...
    'components' => [
        ...
        'objektlisteteilen' => 'Objektliste Teilen',
        'objektlisteteilen_desc' => 'Stellt einen Teilen Button für eine gefilterte Objektliste da.',
    ...
    'OpenGraphMetaTags' => [
        ...
        'description' => 'Füge einen Meta Title hinzu',
    ],
    'bookingask' =>[
