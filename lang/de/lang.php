...
return [
    ...
    'globalsettings' => [
        ...
        'guestlogin' => 'Pfad zu Gästeseite ( Gast-Login)',
        'mailSettingsSection' => 'Mail-Einstellung (Buchung/Anfragen)',
        'mailuser' => 'Mail Absendername',
        'mailuser_desc' => 'Absendername der Statusmeldungen',
        'mailaddr' => 'Absender-Mail',
        'mailaddr_desc' => 'Absender-Mail für den Mail-Header. Wichtig: Im Admin-Bereich die Mail-Einstellungen erfassen oder kontrollieren ',
        'cronSettingsSection' => 'Cron-Einstellungen',
        'mailcc' => 'Weiterleiten an.. (to CC)',
        'mailcc_desc' => 'Mails der Empfänger für Statusmeldungen wie Bewertungseingänge, Buchungs- und Anfragebestätigungen (durch ; getrennt angeben)',
        'mailcccron' => 'Cron-Mails weiterleiten an.. (to CC)',
        'mailcccron_desc' => 'Mails der Cron-Jobs weiterleiten an CC-Adresse)',
        'cronbefore' => 'Anreise Mail versenden Tage',
        'beforedays' => 'Tage vor Anreise',
        'cronafter' => 'Abreise Mail versenden Tage',
        'afterdays' => 'Tage nach Abreise',
        'cronlog' => 'Log für Cron-Jobs',
        'cronlog_desc' => 'Schaltet den Log-Modus für die Crons an',
        'maxreturn' => 'Max. Tage zurück',
        'maxreturn_desc' => 'Berücksichtigt nur Buchungen die max. Tage zurückliegen',
        'objektpath' => 'Detailseite für Bewertungslink',
        'linktext' => 'Text des Bewertungslink',
        'croninfo' =>'<h4>Cron Informationen für Anreise- und Abreise-Mail</h4>Crons funktionieren nur, wenn auf Ihrem Server ein system-cron angelegt ist.<br>' .
                'Z.B. : php/7.2/bin/php /var/www/vhosts/ihredomain.de/artisan schedule:run >> /dev/null 2>&1<br>Ausführungzeit des cron : * * * * * <br>' .
                'Bei anderen Providern kann der CRON auch auf die Domain mit https://www.ihreDomain.de/cron eingestellt werden<br>' .
                'Fragen Sie Ihren Anbieter oder Administrator',
