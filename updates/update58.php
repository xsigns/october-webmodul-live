...
class Update58 extends Migration
{
    protected $modulename = 'update58';
    ...
    public function up()
    {
        ...
        if (Schema::hasTable('xsigns_fewo_angobj'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_art'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_artlang'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_ask'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_auskat'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_auskatlang'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_bewopt'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_bewoptlang'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_entf'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_galleries'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_gast'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_ha'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_la'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_lalang'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_leart'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_objaus'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_objektbilder'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_objlagen'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_orte'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_preiselang'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_reg'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_reinfirma'))
        {
            Schema::table('xsigns_fewo_reinfirma', function ($table)
            {
                ...
                if (Schema::hasColumn('xsigns_fewo_reinfirma', 'rein_mail'))
                    $table->string('rein_mail', 250)->default('')->change();
                else
                    $table->string('rein_mail', 250)->default('');

                if (Schema::hasColumn('xsigns_fewo_reinfirma', 'rein_tel'))
                    $table->string('rein_tel', 25)->default('')->change();
                else
                    $table->string('rein_tel', 25)->default('');
            });
        }
        ...
        if (Schema::hasTable('xsigns_fewo_typ'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_typlang'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_vorgzahl'))
        {
        ...
        if (Schema::hasTable('xsigns_fewo_zulang'))
        {
